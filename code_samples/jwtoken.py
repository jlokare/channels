...
def getUserDetails():
    with open("code_samples/config_files/userDetails.json", "r") as userDetailFile:
...
#     print("Current Working Directory is", os.getcwd())
    with open('code_samples/config_files/allChannels.json', 'r') as allChannelsFile:
...
def getUserChannelSubscribedList():
    ...
    with open('code_samples/config_files/userSubscribedChannels.json', 'w') as userSubChannelFile:
