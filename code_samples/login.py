...
def saveUserDetailsToFile():
    with open('code_samples/config_files/userDetails.json', 'w') as userDetailsFile:
        json.dump(user, userDetailsFile)
#     file_exists = os.path.exists('code_samples/userDetails.json')
#     print("File physical exists? :: ", file_exists)
